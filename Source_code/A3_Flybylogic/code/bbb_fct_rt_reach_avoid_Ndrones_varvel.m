function [xx, yy, zz] = bbb_fct_rt_reach_avoid_Ndrones_varvel(N_drones_arg, current_xx, current_yy, current_zz, obstacle_arg, modified_max_vel)
...
max_vel = modified_max_vel; %.751; % (CJ) param
