...
library(geometry)
library(retistruct)
source("C:/Users/XXX/source/R_project/lib/functions.R")
...
# directory for input 
datalist <- list.files(path = "C:/Users/XXX/source/R_project/project_swarm_model_data/data/01_01_input_regular_01")
...
for(i in 1: endLoop){
  ...
  csvname = paste("C:/Users/XXX/source/R_project/project_swarm_model_data/data/01_01_input_regular_01/",filename,sep="" )
