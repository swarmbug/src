classdef Drone < matlab.mixin.Copyable %handle
    ...
    methods
        ...
        function set_pos(self, position_ned)
            ...
            self.z_hat = true_states([self.get_state(); self.airdata; ...
                                    NaN]);
            %disp('set_pos set_pos set_pos set_pos ')
            %disp(self.z_hat)
        ...
        function set_vel(self, velocity_xyz)
            ...
            %disp('set_vel(self, velocity_xyz) set_vel(self, velocity_xyz) set_vel(self, velocity_xyz)')
        end
        ...
        function set_state(self, pos_ned, vel_xyz, attitude, rates)
            ...
            self.rates = rates;
            disp('set_state set_state set_state set_state');
        end
        ...
        function update_state(self, wind, time)
            ...
            if self.drone_type ~= "point_mass"
                ...
                % dlmwrite('full_command.csv',self.full_command,'delimiter',',','-append');
                % Update true state
...
%                 disp(self.drone_type)
        ...
        function compute_kinematics(self, time)
            ...
            % disp('dbg compute_kinematics: old')
            % disp(x_old(1:3)')
            ...
            % disp('dbg compute_kinematics: new')
            % disp(x_new(1:3)')
