function fitted_dcc = interpolation_dcc(dcc_current, dcc_standard) %Nd = 4 as example
    ...
    if length_current > length_standard
        temp_big_one = length_current;
        temp_small_one = length_standard;
    else
        temp_big_one = length_standard;
        temp_small_one = length_current;
    end
    
    
    %xq = 0:(temp_small_one/temp_big_one):length_standard;
    xq = 0:(length_current/length_standard):length_current;
