function J = getTotalPotential( pos, drone_index, drone_array, obst_array , end_loc, c_loc_pot_c)
%
...
% dlmwrite('coord.csv',obst_array(1).GetPotential( pos ),'delimiter',',','-append');
...
if( drone_array(drone_index).type <= 2 ) % This is an outside drone
    ...
    J = J + FinalLocationPotential( pos, end_loc, c_loc_pot_c);
